module.exports = function (fullAction) {
  ...
  return {
    ...
    renderFilePrimaryActions: _.template(
      '<% if (data.advance){ %>' +
      '<li>' +
      '<a class="btn btn-sm btn-primary btn-toggle-file" href="/projects/<%= data.project %>/file?path=<%= data.filePath %>" target="_blank">' +
      '<i class="glyphicon glyphicon-new-window"></i>' +
      '<span>Fullscreen</span>' +
      '</a>' +
      '</li>' +
      '<% } %>' +
      '<li><button class="btn btn-sm btn-primary btn-edit-file">' +
